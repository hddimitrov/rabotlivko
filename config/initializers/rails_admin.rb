# RailsAdmin config file. Generated on June 26, 2013 00:14
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Rabotlivko', 'Admin']
  ...
  # config.excluded_models = ['Admin', 'Category', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Admin', 'Category', 'User']
